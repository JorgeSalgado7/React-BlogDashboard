                            ...
                            <div className="grid">
                                ...
                                <div className="col-12"> 
                                    <div className="prime-input-container">
                                        ...
                                        <InputText id= 'name' value={name} onChange={(e) => setName(e.target.value)} placeholder="Ej.Kaloni" />
                                    </div>
                                </div>
                                ...
                                <div className="col-12"> 
                                    <div className="prime-input-container">
                                        ...
                                        <MultiSelect id= 'categoria' value={categoria} onChange={(e) => setCategoria(e.target.value)} placeholder="Selecciona una categoría"/>
                                    </div>
                                </div>
